...
(define-test board-instantiation
  ...
  (let* ((board (nb:make-board '(0 0) '(0 -1) '(0 1)))
    ...
    (is equalp (nc:axial 0 0) (gethash (nc:axial 0 0) axials))
    (is equalp (nc:axial 0 -1) (gethash (nc:axial 0 -1) axials))
    (is equalp (nc:axial 0 1) (gethash (nc:axial 0 1) axials))
    (is equalp nil (gethash (nc:axial 1 -1) axials))
    (true (nb:axial-present-p board (nc:axial 0 0)))
    (true (nb:axial-present-p board (nc:axial 0 -1)))
    (true (nb:axial-present-p board (nc:axial 0 1)))
    (false (nb:axial-present-p board (nc:axial 1 -1)))
